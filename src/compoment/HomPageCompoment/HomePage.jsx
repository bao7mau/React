                            ...
                            <div key={index} className="group relative border border-sky-500 rounded-md">
                                ...
                                <div className="mt-4 flex justify-between">
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">CPU: {product[2]}</p>
                                        <p className="mt-1 text-sm text-gray-500">GPU: {product[3]}</p>
                                        <p className="mt-1 text-sm text-gray-500">Ram: {product[4]}</p>
                                        <p className="mt-1 text-sm text-gray-500">ROM: {product[5]}</p>
                                    </div>
                                    <p className="text-sm font-medium text-gray-900">{product[8]} VNĐ</p>
                                </div>
                            </div>
                        ))}
                    </div>
