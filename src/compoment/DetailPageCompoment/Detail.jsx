                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="images p-3">
                            ...
                            <Slide>
                                <div>
                                    <img id="main-image"  style={{ display: 'block', margin: '0 auto' }}  src={product[9]} width="350" alt={product[1]} /> 
                                </div>
                                <div>
                                    <img id="main-image"  style={{ display: 'block', margin: '0 auto' }}  src={product[10]} width="350" alt={product[1]} /> 
                                </div>
                                <div>
                                    <img id="main-image"  style={{ display: 'block', margin: '0 auto' }}  src={product[11]} width="350" alt={product[1]} /> 
                                </div>
                                <div>
                                    <img id="main-image"  style={{ display: 'block', margin: '0 auto' }}  src={product[12]} width="350" alt={product[1]} /> 
                                </div>
                            </Slide>
                            </div>
                        </div>
                        ...
                        <div className="product p-4">
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center"> 
                                    <i className="fa fa-long-arrow-left"></i> <span className="ml-1">Back</span> 
                                </div> 
                            ...
                            <div className="mt-4 mb-3"> 
                                ...
                                <div className="price d-flex flex-row align-items-center"> 
                                    <span className="act-price">${product[8]}</span>
                                </div>
                            </div>
                            <div className="specs mt-5">
                                <h6 className="text-uppercase">Specifications</h6> 
                                <ul>
                                    <li><strong>CPU:</strong> {product[2]}</li>
                                    <li><strong>GPU:</strong> {product[3]}</li>
                                    <li><strong>RAM:</strong> {product[4]}</li>
                                    <li><strong>Storage:</strong> {product[5]}</li>
                                    <li><strong>Display:</strong> {product[6]}" {product[7]}</li>
                                </ul>
                            </div>
